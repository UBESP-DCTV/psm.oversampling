---
title: "PSM Oversampling - Simulation results"
...
# Load results
load(here::here("simulation_results_pop_1000000_n_1000.rda"))
```
...
p_asmd <- ggplot(
  data = df_grid,
  mapping = aes(
    x = ratio, y = asmd, colour = replace, shape = treat_assign
  )
) +
  geom_point() +
  geom_line() +
...
ggplot(
  data = df_grid,
  mapping = aes(
    x = ratio, y = ps_smd, colour = replace, shape = treat_assign
  )
) +
  geom_point() +
  geom_line() +
...
ggplot(
  data = df_grid,
  mapping = aes(
    x = ratio, y = ps_ovc, colour = replace, shape = treat_assign
  )
) +
  geom_point() +
  geom_line() +
  ...
  scale_colour_discrete(name = "Replacement") +
  scale_shape_discrete(name = "Treatment assignment") +
  ylab("Overlapping coefficient of PS") +
  xlab("Oversampling") +
  theme_modern()
```

## Proportion of matched treated
```{r, fig.height = 8, fig.width = 12}
p_mtch_tr <- ggplot(
  data = df_grid,
  mapping = aes(
    x = ratio, y = p_mt, colour = replace, shape = treat_assign
  )
) +
  geom_point() +
  geom_line() +
  ...
  scale_colour_discrete(name = "Replacement") +
  scale_shape_discrete(name = "Treatment assignment") +
  ylab("Proportion of matched treated") +
  xlab("Oversampling") +
  theme_modern()
